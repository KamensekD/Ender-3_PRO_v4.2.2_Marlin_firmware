...
#define Z_PROBE_FEEDRATE_FAST (6*60) //ORIGINAL: #define Z_PROBE_FEEDRATE_FAST (4*60)
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE 5 //ORIGINAL: #define Z_CLEARANCE_DEPLOY_PROBE   10 // Z Clearance for Deploy/Stow
