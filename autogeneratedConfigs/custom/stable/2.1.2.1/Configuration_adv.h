 ...
 */
  ...
  #define WATCH_TEMP_INCREASE 3 //ORIGINAL:   #define WATCH_TEMP_INCREASE 2               // Degrees Celsius
#endif
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD 30 //ORIGINAL:   #define THERMAL_PROTECTION_BED_PERIOD       180 // Seconds
  #define THERMAL_PROTECTION_BED_HYSTERESIS 3 //ORIGINAL:   #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD 60 //ORIGINAL:   #define WATCH_BED_TEMP_PERIOD               180 // Seconds
  #define WATCH_BED_TEMP_INCREASE 3 //ORIGINAL:   #define WATCH_BED_TEMP_INCREASE               2 // Degrees Celsius
#endif
...
#define LIN_ADVANCE //ORIGINAL: //#define LIN_ADVANCE
    ...
    #define ADVANCE_K 0.5 //ORIGINAL:     #define ADVANCE_K { 0.22 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.5 //ORIGINAL:     #define ADVANCE_K 0.22        // (mm) Compression length applying to all extruders
  #endif
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V //ORIGINAL:   #define CHOPPER_TIMING CHOPPER_DEFAULT_12V        // All axes (override below)
